...
# Import article_extractor to ensure it's loaded when the package is imported
# This forces the module to be loaded even if service_registry doesn't import it directly
try:
...
# Import other service modules to ensure they're loaded
try:
